...
export default function PortfolioGrid() {
  // ✅ Array de proyectos aquí dentro
  const projects: Project[] = [
    {
      id: "1",
      title: "Gestion de Gastos",
      image: "https://picsum.photos/600/400?random=4",
      url: "https://ejemplo.com/srac",
      description: "Sitio para gestionar gastos en tiempo real",
    ...
    },
    {
      ...
      url: "https://ejemplo.com/punt-vital",
    ...
    },
    {
      ...
      description: "Sitio web de adopcion de mascotas",
      tags: ["Laravel", "MySQL"],
    },
  ];
