    ...
    return(
        <>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white z-10">
                ...
                <a href="/nosotros" className="bg-orange-500 hover:bg-orange-600 text-white py-3 px-6 rounded-md font-semibold transition duration-300 ease-in-out">Conoce mas</a>
            </div>
